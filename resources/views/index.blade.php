...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="{{asset('landing/theme/css/base.css')}}">
    <link rel="stylesheet" href="{{asset('landing/theme/css/vendor.css')}}">
    <link rel="stylesheet" href="{{asset('landing/theme/css/main.css')}}">

    <!-- script
    ================================================== -->
    <script src="{{asset('landing/theme/js/modernizr.js')}}"></script>
    {{--  <script src="{{asset('landing/theme/js/pace.min.js')}}"></script>  --}}
...
<body id="top">
    ...
    <!-- home
    ================================================== -->
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="{{asset('landing/theme/images/hero-bg.jpg')}}" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <h1>
                    Do you have business ?   <br>
                    Manage your projects and employees without any pain. <br>
                    You are an employee <br>
                    Find your business here 
                </h1>

                <div class="home-content__buttons">
                    <a href="{{url('register/project-manager')}}" class="btn btn--stroke">
                        Company
                    </a>
                    <a href="{{url('register/employee')}}" class="btn btn--stroke">
                        Employee
                    </a>
                </div>
    ...
    <!-- Java Script
    ================================================== -->
    <script src="{{asset('landing/theme/js/jquery-3.2.1.min.js')}}"></script>
    <script src="{{asset('landing/theme/js/plugins.js')}}"></script>
